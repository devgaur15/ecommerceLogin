...
$username = $password = $firstname = $lastname = $address = $city = $state = NULL;
$usernameerr = $passworderr = $firstnameerr = $lastnameerr = NULL;
...
if (empty($_POST["lastname"])) {
  ...
  $sql = "INSERT INTO signup (username,password,firstname,lastname,address,city,state) VALUES('$username', '$password', '$firstname', '$lastname', '$address', '$city', '$state') ";
  if ($connection->query($sql) === TRUE) {
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Success! You have signed up successfully.....click to login</strong>
    ...
    <strong>Error! Sign Up unsuccessful TRY AGAIN</strong> 
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    </button>
  </div>';
} 
  ...
  echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error! Already Existing Username</strong> Try another username 
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            </button>
          </div>';
}
...
?>
    ...
    <form action="/melisdata/signup.php" method="post">
