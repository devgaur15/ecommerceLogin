...
<body>
    <!-- php code                username ko yha laake daal dunga-->
    ...
    $firstname = $lastname = $address = $city = $state = $description = $url = $username = NULL;
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($flag) {
			...
			$sql = "INSERT INTO modaldata (username,firstname,lastname,address,city,state,description,url) VALUES('$username', '$firstname', '$lastname', '$address', '$city', '$state', '$description', '$url') ";
...
?>
    ...
    <!-- php code -->
     ...
     <div class="header">
    <button type="button" class="btn btn-light"><a href="sellerdisplay.php"><b>Display Seller</b></a></button>

     </div>
<div class="wrapper">
        <h2>Become Seller</h2>
        <p>Please fill this form to give seller details for the username <?php echo $_SESSION['username']; ?></p>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="description" placeholder="City">
    </div>
    <div class="form-group col-md-6">
