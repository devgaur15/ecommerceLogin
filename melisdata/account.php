...
//  echo $testing;
$sql = "SELECT * FROM signup WHERE username='$testing'"; // where user id=$Id;
$result = mysqli_query($connection, $sql);
$num = mysqli_num_rows($result); // repeat once (x)
if($num>= 0){
    $data = mysqli_fetch_array($result);// from here (x)

    $userid = $data['id'];                                                                                      
    // echo "$userid";
    // echo "\r\n";
    $uname = $data['username']; // html special characters
    // echo "$uname";
    // echo "\r\n";
    $pass = $data['password'];
    // echo "$pass";
...
<!-- php code ends -->
    ...
    <h4>My Account</h4>
    <div class="header">
    <button type="button" class="btn btn-light"><a href="profile.php"><b>Edit Profile</b></a></button>
    <button type="button" class="btn btn-light"><a href="seller.php"><b>Become a Seller</b></a></button>
    <!-- <button type="button" class="btn btn-light"><a href="sellerdisplay.php"><b>Display Seller</b></a></button> -->
    </div>
    <form>
    <div class="form-group">
                <label>Username*</label>
                <input type="text" name="username" class="form-control" value="<?php echo $uname;?>" placeholder="">
            </div>  
            <div class="form-group">
                <label>Password*</label>
                <input type="password" name="password" class="form-control" value="<?php echo $pass;?>" placeholder="">
          </div>
          <div class="form-row">
